...
bool	Server::USER(User &user, std::string &params)
{
	...
	return this->replyPush(user, "001 " + user.getNickname() + " :Welcome to the Mine.")
		...
		&& this->replyPush(user, "004 " + user.getNickname() + " :" + this->_config["server_name"] + " " + this->_config["server_version"] + ' ' + User::availableModes() + ' ' + Channel::availableModes() + '.');
}
